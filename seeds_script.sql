...
VALUES
    ((SELECT id FROM users WHERE username = 'user1'), 'Reader'),
...
VALUES
    ('Technology', 'Here you can find information about new developments in technology', NULL),
    ('Lifestyle', 'Useful habits, hobbies and communication', NULL);
INSERT INTO categories (name, description, parent_id)
VALUES
    ('Programming', 'About programming languages and frameworks', (SELECT id FROM categories WHERE name = 'Technology'));
INSERT INTO categories (name, description, parent_id)
VALUES
    ('Databases', 'About different databases', (SELECT id FROM categories WHERE name = 'Programming'));
...
VALUES
    ((SELECT id FROM posts WHERE title = 'How to Start Programming'), 'Scheduled', now() + INTERVAL '1 day'),
...
VALUES
    ((SELECT id FROM posts WHERE title = 'How to Start Programming'), (SELECT id FROM categories WHERE name = 'Programming')),
    ((SELECT id FROM posts WHERE title = 'How to Play Guitar'), (SELECT id FROM categories WHERE name = 'Lifestyle')),
    ((SELECT id FROM posts WHERE title = 'Top 5 AI Trends in 2024'), (SELECT id FROM categories WHERE name = 'Technology')),
    ((SELECT id FROM posts WHERE title = 'Some words about PostgreSQL'), (SELECT id FROM categories WHERE name = 'Databases'));
...
VALUES
    ((SELECT id FROM posts WHERE title = 'How to Start Programming'), (SELECT id FROM users WHERE username = 'user2'), 'Great guide for beginners!', now(), now(), NULL),
    ((SELECT id FROM posts WHERE title = 'Top 5 AI Trends in 2024'), (SELECT id FROM users WHERE username = 'user1'), 'Really insightful post!', now(), now(), NULL),
    ((SELECT id FROM posts WHERE title = 'Top 5 AI Trends in 2024'), (SELECT id FROM users WHERE username = 'user2'), 'Boring.', now(), now(), NULL),
    ((SELECT id FROM posts WHERE title = 'Some words about PostgreSQL'), (SELECT id FROM users WHERE username = 'user1'), 'MySQL is the best RDBMS!', now(), now(), NULL);

INSERT INTO polls (post_id, author_id, description)
VALUES
    ((SELECT id FROM posts WHERE title = 'Top 5 AI Trends in 2024'), (SELECT id FROM users WHERE username = 'user2'), 'Which AI trend is most exciting for you?'),
...
VALUES
    ((SELECT id FROM polls WHERE description = 'Which AI trend is most exciting for you?'), 'Generative AI'),
